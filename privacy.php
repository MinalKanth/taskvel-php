...
<title>Privacy Policy | Samal Consultancy &amp; TaskVel Pro</title>
<meta name="description" content="Privacy Policy covering Samal Consultancy's advisory services and the TaskVel Pro application.">
<link rel="canonical" href="https://www.samalconsultancy.com/privacy.php">
...
<header class="legal-hero">
  <div class="wrap">
    ...
    <p>This Privacy Policy explains what personal data Samal Consultancy collects across our consultancy services and TaskVel Pro, why we collect it, and the choices you have.</p>
    ...
    <div class="legal-hero-links">
      <a href="terms.php">📄 Read our Terms &amp; Conditions →</a>
    </div>
  </div>
</header>
...
<div class="legal-toc">
  <div class="wrap">
    <div class="legal-toc-card">
      <a href="#scope"><span class="n">1</span> Scope</a>
      <a href="#data"><span class="n">2</span> Information we collect</a>
      <a href="#use"><span class="n">3</span> How we use it</a>
      <a href="#cookies"><span class="n">4</span> Cookies &amp; local storage</a>
      <a href="#sharing"><span class="n">5</span> Who we share data with</a>
      <a href="#security"><span class="n">6</span> Security &amp; retention</a>
      <a href="#rights"><span class="n">7</span> Your rights &amp; choices</a>
      <a href="#children"><span class="n">8</span> Children's privacy</a>
      <a href="#international"><span class="n">9</span> Where data is processed</a>
      <a href="#changes"><span class="n">10</span> Changes to this Policy</a>
...
<main class="legal-body">
  <div class="wrap">
    ...
    <div class="legal-section" id="scope">
      <h3><span class="num">1</span> Scope</h3>
    ...
    <div class="legal-section" id="use">
      <h3><span class="num">3</span> How we use this information</h3>
      <ul>
    ...
    <div class="legal-section" id="cookies">
      <h3><span class="num">4</span> Cookies &amp; local storage</h3>
    ...
    <div class="legal-section" id="sharing">
      <h3><span class="num">5</span> Who we share data with</h3>
      <ul>
        ...
        <li>Other members of your Team or Organization, limited to the shared/work-related data described in our Terms &amp; Conditions §8.</li>
      </ul>
    ...
    <div class="legal-section" id="security">
      <h3><span class="num">6</span> Data security &amp; retention</h3>
    ...
    <div class="legal-section" id="rights">
      <h3><span class="num">7</span> Your rights &amp; choices</h3>
      <ul>
    ...
    <div class="legal-section" id="children">
      <h3><span class="num">8</span> Children's privacy</h3>
    ...
    <div class="legal-section" id="international">
      <h3><span class="num">9</span> Where your data is processed</h3>
    ...
    <div class="legal-section" id="changes">
      <h3><span class="num">10</span> Changes to this Policy</h3>
    ...
    <div class="legal-contact-card" id="legal-contact">
      <span class="eyebrow" style="color:var(--amber-2);">Questions about your data</span>
      <p style="color:rgba(250,247,242,0.8); margin-top:8px;">For a data access, correction or deletion request, or any privacy question, reach us at:</p>
