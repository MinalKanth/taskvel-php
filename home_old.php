...
.footer-logo{height:34px; width:auto; max-width:170px; object-fit:contain; margin-bottom:4px; filter:brightness(0) invert(1);}
  ...
  <div class="wrap">
    <div class="footer-grid">
      ...
      <div class="footer-col">
        <h5>Company</h5>
        <ul><li><a href="#about">About Us</a></li><li><a href="#services">Services</a></li><li><a href="#process">Process</a></li><li><a href="#contact">Contact</a></li></ul>
      </div>
      <div class="footer-col">
        <h5>Services</h5>
