...
<title>Terms &amp; Conditions | Samal Consultancy &amp; TaskVel Pro</title>
<meta name="description" content="Terms of Service covering Samal Consultancy's advisory services and the TaskVel Pro application.">
<link rel="canonical" href="https://www.samalconsultancy.com/terms.php">
...
body{ margin:0; font-family:var(--font-body); background:var(--ivory); color:var(--charcoal); -webkit-font-smoothing:antialiased; overflow-x:hidden; }
...
.eyebrow{ font-family:var(--font-eyebrow); font-size:12px; font-weight:600; letter-spacing:.12em; text-transform:uppercase; display:inline-flex; align-items:center; gap:8px; color:var(--teal-deep); }
...
.btn{ position:relative; overflow:hidden; display:inline-flex; align-items:center; justify-content:center; gap:10px; padding:15px 26px; font-weight:600; font-size:14.5px; border-radius:100px; text-decoration:none; cursor:pointer; border:1px solid transparent; transition:transform .35s var(--ease), box-shadow .35s var(--ease), background .3s ease, color .3s ease; white-space:nowrap; -webkit-tap-highlight-color:transparent; }
...
/* ============================= NAVBAR — identical structure to index.php, rendered
   permanently in its "scrolled" state (no hero photo behind it on this inner page). ============================= */
.navbar{ position:fixed; top:0; left:0; right:0; z-index:999; padding:10px 0; background:rgba(250,247,242,0.92); backdrop-filter:blur(16px) saturate(160%); box-shadow:0 8px 30px -14px rgba(27,31,39,0.18); }
.nav-inner{display:flex; align-items:center; justify-content:space-between; gap:16px;}
.brand{display:flex; align-items:center; gap:10px; text-decoration:none; min-width:0;}
.brand-logo{height:36px; width:auto; max-width:150px; object-fit:contain; flex-shrink:0;}
.brand-mark{ width:36px;height:36px;border-radius:10px; flex-shrink:0; background:linear-gradient(145deg,var(--amber),var(--teal-deep)); display:none; align-items:center;justify-content:center; color:#fff; font-family:var(--font-display); font-weight:700; font-size:15px; box-shadow: inset 0 0 0 1px rgba(255,255,255,0.15); }
...
.nav-links{ position:fixed; inset:0 0 0 auto; width:min(320px,82%); height:100dvh; background:linear-gradient(180deg,var(--navy-ink),var(--teal-deep)); flex-direction:column; justify-content:center; align-items:flex-start; padding:40px; gap:26px; transform:translateX(100%); transition:transform .45s var(--ease); box-shadow:-20px 0 60px rgba(0,0,0,0.25); }
...
.legal-hero-links{ display:flex; gap:10px; margin-top:26px; flex-wrap:wrap; }
.legal-hero-links a{ display:inline-flex; align-items:center; gap:8px; padding:10px 18px; border-radius:100px; border:1px solid rgba(250,247,242,0.25); color:var(--ivory); text-decoration:none; font-family:var(--font-eyebrow); font-size:12.5px; font-weight:600; transition:background .25s ease, border-color .25s ease; }
.legal-hero-links a:hover{ background:rgba(250,247,242,0.10); border-color:rgba(250,247,242,0.5); }

/* ============================= TABLE OF CONTENTS ============================= */
.legal-toc{ margin-top:-34px; position:relative; z-index:2; }
.legal-toc-card{ background:var(--paper); border:1px solid var(--line); border-radius:var(--radius-lg); box-shadow:var(--shadow-lg); padding:22px; display:grid; grid-template-columns:1fr; gap:8px; }
@media (min-width:640px){ .legal-toc-card{grid-template-columns:1fr 1fr; padding:26px 30px;} }
.legal-toc-card a{ display:flex; align-items:center; gap:10px; text-decoration:none; color:var(--navy-ink); font-family:var(--font-display); font-weight:600; font-size:14px; padding:10px 12px; border-radius:10px; transition:background .25s var(--ease), color .25s var(--ease); }
.legal-toc-card a:hover{ background:rgba(201,162,39,0.10); color:var(--amber-deep); }
.legal-toc-card a span.n{ width:22px; height:22px; border-radius:7px; background:var(--navy-ink); color:var(--ivory); display:inline-flex; align-items:center; justify-content:center; font-size:11.5px; flex-shrink:0; }
...
.legal-note{ margin-top:16px; padding:16px 18px; border-radius:var(--radius-md); border:1px solid rgba(201,162,39,0.35); background:rgba(201,162,39,0.08); }
.legal-note p{ color:var(--navy-ink); font-size:14px; margin-top:0; }
.legal-note strong{ color:var(--amber-deep); }

.legal-contact-card{ margin-top:20px; padding:22px 24px; border-radius:var(--radius-lg); background:var(--navy-ink); color:var(--ivory); display:grid; gap:6px; box-shadow:var(--shadow-sm); }
...
/* Back to top / scroll progress — identical to index.php */
.back-to-top{ position:fixed; right:18px; bottom:28px; width:46px; height:46px; border-radius:50%; background:rgba(27,31,39,0.85); border:1px solid rgba(255,255,255,0.14); backdrop-filter:blur(10px); color:var(--teal-2); display:flex; align-items:center; justify-content:center; cursor:pointer; z-index:900; opacity:0; visibility:hidden; transform:translateY(16px); transition:opacity .4s var(--ease), transform .4s var(--ease), background .3s ease, border-color .3s ease; box-shadow:var(--shadow-sm); -webkit-tap-highlight-color:transparent; }
...
.scroll-progress{ position:fixed; top:0; left:0; height:3px; width:0%; z-index:1200; background:linear-gradient(90deg,var(--amber),var(--amber-2),var(--teal-2)); box-shadow:0 0 14px rgba(232,199,102,0.55); transition:width .12s linear; }
</style>
</head>
<body>
...
<header class="legal-hero">
  <div class="wrap">
    ...
    <p>These Terms cover both Samal Consultancy's professional advisory services and the TaskVel Pro application. Please read them before engaging our services or creating an account.</p>
    ...
    <div class="legal-hero-links">
      <a href="privacy.php">🔒 Read our Privacy Policy →</a>
    </div>
  </div>
</header>
...
<div class="legal-toc">
  <div class="wrap">
    <div class="legal-toc-card">
      <a href="#definitions"><span class="n">1</span> Definitions &amp; acceptance</a>
      <a href="#consultancy"><span class="n">2</span> Consultancy engagements</a>
      <a href="#taskvel-overview"><span class="n">3</span> TaskVel Pro — what it is</a>
      <a href="#taskvel-billing"><span class="n">4</span> Plans, free trials &amp; billing</a>
      <a href="#trading"><span class="n">5</span> Trading Journal disclaimer</a>
      <a href="#acceptable-use"><span class="n">6</span> Acceptable use</a>
      <a href="#ip"><span class="n">7</span> Intellectual property</a>
      <a href="#org-data"><span class="n">8</span> Teams &amp; organization access</a>
      <a href="#termination"><span class="n">9</span> Suspension &amp; termination</a>
      <a href="#disclaimer"><span class="n">10</span> Disclaimers &amp; liability</a>
      <a href="#law"><span class="n">11</span> Governing law &amp; changes</a>
      <a href="#legal-contact"><span class="n">✉</span> Contact us</a>
    </div>
  </div>
</div>
...
<main class="legal-body">
  <div class="wrap">
    ...
    <div class="legal-section" id="definitions">
      <h3><span class="num">1</span> Definitions &amp; acceptance</h3>
      <p>These Terms &amp; Conditions ("Terms") are a legal agreement between you and Samal Consultancy ("Samal Consultancy", "the Company", "we", "us", "our"), a professional advisory practice based in Nagaon, Assam, India, and cover both (a) the offline and online consultancy services described on samalconsultancy.com, and (b) TaskVel Pro, the task-management application we build and operate. By engaging our consultancy services or by creating a TaskVel Pro account, you agree to these Terms.</p>
    ...
    <div class="legal-section" id="consultancy">
      <h3><span class="num">2</span> Consultancy engagements</h3>
      <p>Where you engage Samal Consultancy for GST, EPFO/ESIC, company registration, trademark or tax-advisory work, the following applies in addition to the rest of these Terms:</p>
      <ul>
    ...
    <div class="legal-section" id="taskvel-overview">
      <h3><span class="num">3</span> TaskVel Pro — what it is</h3>
    ...
    <div class="legal-section" id="taskvel-billing">
      <h3><span class="num">4</span> Plans, free trials &amp; billing</h3>
    ...
    <div class="legal-section" id="trading">
      <h3><span class="num">5</span> Trading Journal — important disclaimer</h3>
    ...
    <div class="legal-section" id="acceptable-use">
      <h3><span class="num">6</span> Acceptable use</h3>
      <ul>
    ...
    <div class="legal-section" id="ip">
      <h3><span class="num">7</span> Intellectual property &amp; your content</h3>
    ...
    <div class="legal-section" id="org-data">
      <h3><span class="num">8</span> Teams &amp; organization access</h3>
    ...
    <div class="legal-section" id="termination">
      <h3><span class="num">9</span> Suspension &amp; termination</h3>
    ...
    <div class="legal-section" id="disclaimer">
      <h3><span class="num">10</span> Disclaimers &amp; limitation of liability</h3>
    ...
    <div class="legal-section" id="law">
      <h3><span class="num">11</span> Governing law &amp; changes</h3>
    ...
    <div class="legal-contact-card" id="legal-contact">
      <span class="eyebrow" style="color:var(--amber-2);">Questions about these Terms</span>
      <p style="color:rgba(250,247,242,0.8); margin-top:8px;">For anything relating to these Terms or a TaskVel Pro billing question, reach us at:</p>
